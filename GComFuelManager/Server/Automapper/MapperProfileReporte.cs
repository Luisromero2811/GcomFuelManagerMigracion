...
namespace GComFuelManager.Server.Automapper
{
    public class MapperProfileReporte : Profile
    {
        public MapperProfileReporte()
        {
            ...
            CreateMap<InventarioTotalesDTO, InventarioTotalesExcelDTO>();
            ...
            CreateMap<AnalisisOrdenCargada, AnalisisOrdenCargadaExcelDTO>()
                .ForMember(x => x.Operador, op => op.MapFrom(x => $"{x.OperadorFullName}"));
        }
    }
}
