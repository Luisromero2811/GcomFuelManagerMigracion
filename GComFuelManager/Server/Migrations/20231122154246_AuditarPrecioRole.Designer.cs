...
namespace GComFuelManager.Server.Migrations
{
    ...
    [Migration("20231122154246_AuditarPrecioRole")]
    partial class AuditarPrecioRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GComFuelManager.Shared.Modelos.OrdenEmbarque", b =>
                {
                    ...
                    b.HasIndex("FolioSyn")
                        .IsUnique()
                        .HasFilter("[FolioSyn] IS NOT NULL");
            ...
            modelBuilder.Entity("GComFuelManager.Shared.Modelos.OrdenPedido", b =>
                {
                    ...
                    b.Property<string>("Folio_Cierre_Copia")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("Pedido_Original")
                        .HasColumnType("int");

                    b.HasKey("Cod");

                    b.HasIndex("CodCierre");
            ...
            modelBuilder.Entity("GComFuelManager.Shared.Modelos.OrdenEmbarque", b =>
                {
                    ...
                    b.HasOne("GComFuelManager.Shared.Modelos.Orden", "Orden")
                        ...
                        .HasForeignKey("GComFuelManager.Shared.Modelos.OrdenEmbarque", "FolioSyn")
                        .HasPrincipalKey("GComFuelManager.Shared.Modelos.Orden", "Ref");
            ...
            modelBuilder.Entity("GComFuelManager.Shared.Modelos.OrdenPedido", b =>
                {
                    b.HasOne("GComFuelManager.Shared.Modelos.OrdenCierre", "OrdenCierre")
                        .WithMany("OrdenPedidos")
                        .HasForeignKey("CodCierre");
