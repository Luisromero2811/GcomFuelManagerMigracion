...
namespace GComFuelManager.Server.Migrations
{
    ...
    [Migration("20230807160033_Precioautomatico")]
    partial class Precioautomatico
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GComFuelManager.Shared.Modelos.OrdenEmbarque", b =>
                {
                    ...
                    b.HasIndex("Bolguidid")
                        .IsUnique()
                        .HasFilter("[Bolguidid] IS NOT NULL");
            ...
            modelBuilder.Entity("GComFuelManager.Shared.Modelos.OrdenEmbarque", b =>
                {
                    b.HasOne("GComFuelManager.Shared.Modelos.Orden", "Orden")
                        ...
                        .HasForeignKey("GComFuelManager.Shared.Modelos.OrdenEmbarque", "Bolguidid")
                        .HasPrincipalKey("GComFuelManager.Shared.Modelos.Orden", "Bolguiid");
